def test_click(page):
    ...
    # para rodar no cmd:
    # uv    run    pytest    tests / Command / command5.py - -headed
    ...
    # 2.    Execute    pelo    terminal    na    pasta    do    projeto    Abra  um  terminal  na  pasta  do   projeto  e   execute:  cd "C:\Users\NatanaelNote\PycharmProjects\Automacao-de-Testes-com-Playwright-Python-e-Pytest"  uv  run  pytest  tests / Command / command5.py - -headed - s